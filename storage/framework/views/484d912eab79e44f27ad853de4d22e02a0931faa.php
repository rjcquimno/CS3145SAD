...
<?php $component->withAttributes(['class' => 'p-10 max-w-lg mx-auto mt-24']); ?>
    ...
    <form method="POST" action="/editprocurement/<?php echo e($purchase->id); ?>" enctype="multipart/form-data">
       <?php echo csrf_field(); ?>
       <?php echo method_field('PUT'); ?>
        ...
        <div class="mb-6">
            ...
            <input type="text" class="border border-gray-200 rounded p-2 w-full"
                name="sup_name" value="<?php echo e($supplier); ?>"  readonly/>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-6">
            ...
            <input type="text" class="border border-gray-200 rounded p-2 w-full"
                name="emp_fullName" value="<?php echo e($employee); ?>"  readonly/>
            <?php $__errorArgs = ['sup_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-6">
            ...
            <input type="text" class="border border-gray-200 rounded p-2 w-full"
                name="date_today" value="<?php echo e($purchase->date_today); ?>" readonly/>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-6">
            ...
            <input
                ...
                value="<?php echo e($purchase->item_name); ?>" readonly
            />
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-6">
            ...
            <input
                ...
                value="<?php echo e($purchase->purchase_quantity); ?>" readonly
            />
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-6">
            ...
            <input
                ...
                value="<?php echo e($purchase->purchase_cost); ?>" readonly
            />
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-6">
            ...
            <input
                ...
                value="<?php echo e($purchase->purchase_status); ?>"
            />
...
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?><?php /**PATH C:\Users\jgram\Documents\GitHub\CS3145SAD\resources\views/editpurchaseorder.blade.php ENDPATH**/ ?>