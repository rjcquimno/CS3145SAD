    ...
    <form method="POST" action="/employee" enctype="multipart/form-data">
        ...
        <div class="mb-6">
            ...
            <input type="text" class="border border-gray-200 rounded p-2 w-full"
                name="emp_fullName" value="<?php echo e(old('emp_fullName')); ?>" placeholder="John Doe"/>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-6">
            ...
            <input type="text" class="border border-gray-200 rounded p-2 w-full"
                name="emp_phoneNum" placeholder="09126459067" value="<?php echo e(old('emp_phoneNum')); ?>"/>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-6">
            ...
            <input type="text" class="border border-gray-200 rounded p-2 w-full"
                name="emp_address" value="<?php echo e(old('emp_address')); ?>" placeholder="Davao City"/>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-6">
            ...
            <input type="text" class="border border-gray-200 rounded p-2 w-full"
                name="emp_email" value="<?php echo e(old('emp_email')); ?>" placeholder="test@gmail.com"/>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-6">
            ...
            <input type="text" class="border border-gray-200 rounded p-2 w-full"
                name="emp_gender" value="<?php echo e(old('emp_gender')); ?>" placeholder="Male"/>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-6">
            ...
            <input type="date" class="border border-gray-200 rounded p-2 w-full"
                name="emp_birthdate" value="<?php echo e(old('emp_birthdate')); ?>" placeholder="Male"/>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-6">
            ...
            <input type="text" class="border border-gray-200 rounded p-2 w-full"
                name="emp_role" value="<?php echo e(old('emp_role')); ?>" placeholder="Cashier"/>
...
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?><?php /**PATH C:\Users\jgram\Documents\GitHub\CS3145SAD\resources\views/createemployee.blade.php ENDPATH**/ ?>